...
class PiaApi {
    ...
    setupRoutes() {
        ...
        this.app.get('/users/:id', (req, res) => userController.getUserById(req, res));
        this.app.post('/users', (req, res) => userController.createUser(req, res));
        this.app.put('/users/:id', (req, res) => userController.updateUserById(req, res));
        this.app.delete('/users/:id', (req, res) => userController.deleteUserById(req, res));
